...
type Notary struct { // 公证人
	...
	RsaPublicKey       map[string]string
}
...
//		}
//		for { // 加载RSA密钥对
//			// 这里需要启动soket等待所有的投票者将自己的RSA公钥发送到服务器
//			// ConveyUtils.RecvFrom()
//			break
//		}
//	}

func (n *Notary) Work(I BallotMakeController, conn net.Conn, CandidateConnList *[]net.Conn) {
	I.MakeBallotTickets(conn, CandidateConnList)
}
